...
st.header('Fashion Recommendation system')         #to show the header of the app
...
if upload_file is not None:
    ...
    col1,col2,col3,col4,col5 =st.columns(5)         #to show the recommended images in 5 columns
    with col1:
